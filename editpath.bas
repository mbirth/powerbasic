...
if PATH$(chosen)="" then
  color 14,1
  locate 25,19:print"Keine Eingabe, Lîschen oder Behalten (L/B)?";
...
print"Wollen Sie die énderungen schreiben (J/N)?";
5gosub InpKey
...
print Zustand$
print
print"Vielen Dank fÅr die Benutzung von EditPath!"
print
